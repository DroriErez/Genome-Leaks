...
class attack(ABC):
    ...
    def fit(self, non_train_data: np.ndarray, synthetic_data: np.ndarray, thr: float = 0.5, modelWrapper=None) -> None:
    ...
    def _fit(self, non_train_data: np.ndarray, synthetic_data: np.ndarray, modelWrapper=None) -> None:
        return None
